...
(function(g){
  ...
  // PACS0013 — embedded mirror of content/tone-pack.json; keep keys+copy identical (Content.get returns the path string on miss, no throw) — AGENTS.md (known sites, not exhaustive)
  const DEFAULT_PACK = {
    unitFlavorNames: {
      worker: ['Worker'],
      vehicle: ['Vehicle'],
